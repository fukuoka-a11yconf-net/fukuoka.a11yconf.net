...
<Main>
	<Section width="narrow">
		...
		<TextBody>
			...
			<p>
				また、一般参加者同士の交流では、お互いの個を尊重し、個人の境界を守ることが重要です。他者への無意識の偏見やマイクロアグレッションを避け、個の情報を自己の利益のために一方的に搾取する行動を避けるよう努めてください。外見や個人的特徴に基づく仮定を避け、プライバシーを尊重し、平等な学びと交流の場を提供することを目指しています。
			</p>
			<ul>
				<li>見た目や声などから推測した年齢や性別に基づいて不適切な質問をすること</li>
				<li>他人の障害の経験や困りごとを自己の知識や利益のためだけに同意なく問うこと</li>
				<li>相手の同意なく、個人的な情報（障害の有無や内容を含む）を掘り下げること</li>
				<li>個人的な境界を越える質問やコメントを避けること</li>
			</ul>
			<p>
