...
<svelte:head>
	<title>運営について | アクセシビリティカンファレンス福岡2025</title>
</svelte:head>
...
<Main>
	...
	<Section width="narrow">
		...
		<dl>
			...
			<div>
				<dt>お問い合わせ</dt>
				<dd>fukuokaa11yconf@googlegroups.com</dd>
			</div>
		</dl>
	</Section>
	...
	<Section width="narrow">
		...
		<Heading level={2}>サウンドロゴ</Heading>
		<Heading level={5}>2024実行委員長（ゆうてん）よりコメント</Heading>
